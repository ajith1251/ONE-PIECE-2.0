...
- **Phase 2L** (2026-08-01): Cross-Entity Relationship Convention — ✅ COMPLETE. Doc: `src/data/shared/relationships.md` (ID-only relationships; stored-both + declared source of truth per relationship; cardinality rules; standard field naming; relationship matrix; cascade + validation principles). No production logic changed.
